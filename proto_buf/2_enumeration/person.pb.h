...
enum Person_PhoneType : int {
  Person_PhoneType_UNKNOWN = 0,
  Person_PhoneType_MOBILE = 1,
  Person_PhoneType_HOME = 2,
  Person_PhoneType_WORK = 3
};
bool Person_PhoneType_IsValid(int value);
constexpr Person_PhoneType Person_PhoneType_PhoneType_MIN = Person_PhoneType_UNKNOWN;
...
class Person PROTOBUF_FINAL :
 ...
 public:
  ...
  static constexpr PhoneType UNKNOWN =
    Person_PhoneType_UNKNOWN;
  ...
  ::PERSON::Person_PhoneType phone_type() const;
  void set_phone_type(::PERSON::Person_PhoneType value);
  private:
  ::PERSON::Person_PhoneType _internal_phone_type() const;
  void _internal_set_phone_type(::PERSON::Person_PhoneType value);
  public:
...
// optional .PERSON.Person.PhoneType phone_type = 4;
inline bool Person::_internal_has_phone_type() const {
  bool value = (_has_bits_[0] & 0x00000008u) != 0;
  return value;
}
inline bool Person::has_phone_type() const {
  return _internal_has_phone_type();
}
inline void Person::clear_phone_type() {
  phone_type_ = 0;
  _has_bits_[0] &= ~0x00000008u;
}
inline ::PERSON::Person_PhoneType Person::_internal_phone_type() const {
  return static_cast< ::PERSON::Person_PhoneType >(phone_type_);
}
inline ::PERSON::Person_PhoneType Person::phone_type() const {
  // @@protoc_insertion_point(field_get:PERSON.Person.phone_type)
  return _internal_phone_type();
}
inline void Person::_internal_set_phone_type(::PERSON::Person_PhoneType value) {
  assert(::PERSON::Person_PhoneType_IsValid(value));
  _has_bits_[0] |= 0x00000008u;
  phone_type_ = value;
}
inline void Person::set_phone_type(::PERSON::Person_PhoneType value) {
  _internal_set_phone_type(value);
  // @@protoc_insertion_point(field_set:PERSON.Person.phone_type)
}
...
template <> struct is_proto_enum< ::PERSON::Person_PhoneType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::PERSON::Person_PhoneType>() {
  return ::PERSON::Person_PhoneType_descriptor();
}
